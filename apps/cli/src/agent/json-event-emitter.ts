 ...
 *
 * This class transforms internal CLI events (MeowCodeMessage, state changes, etc.)
...
/**
 * Parse tool information from a MeowCodeMessage text field.
...
export class JsonEventEmitter {
	...
	/**
	 * Handle a MeowCodeMessage and emit the appropriate JSON event.
	 */
	private handleMessage(msg: MeowCodeMessage, _isUpdate: boolean): void {
	 ...
	 */
	private handleSayMessage(msg: MeowCodeMessage, contentToSend: string | null, isDone: boolean): void {
		switch (msg.say) {
			case "text":
	 ...
	 */
	private handleReasoningMessage(msg: MeowCodeMessage, isDone: boolean): void {
	 ...
	 */
	private handleAskMessage(msg: MeowCodeMessage, isDone: boolean): void {
		switch (msg.ask) {
			case "tool":
	...
	private handleToolUseAsk(msg: MeowCodeMessage, subtype: "tool" | "command" | "mcp", isDone: boolean): void {
	...
	private handleCommandOutputMessage(msg: MeowCodeMessage, isDone: boolean): void {
