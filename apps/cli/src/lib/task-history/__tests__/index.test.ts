import { readTaskSessionsFromStoragePath } from "@meow-code/core/cli"
...
vi.mock("@meow-code/core/cli", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@meow-code/core/cli")>()
	return {
		...actual,
