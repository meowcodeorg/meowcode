import { type Keys, type MeowCodeSettings, GLOBAL_SETTINGS_KEYS, PROVIDER_SETTINGS_KEYS } from "@meow-code/types"

import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui"

export const MEOW_CODE_SETTINGS_KEYS = [
	...new Set([...GLOBAL_SETTINGS_KEYS, ...PROVIDER_SETTINGS_KEYS]),
] as Keys<MeowCodeSettings>[]

type SettingsDiffProps = {
	defaultSettings: MeowCodeSettings
	customSettings: MeowCodeSettings
}
	...
	return (
		<div className="border rounded-sm">
			<Table>
				...
				<TableBody>
					{MEOW_CODE_SETTINGS_KEYS.map((key) => {
