...
const DESCRIPTION =
	"Privacy policy for MeowCode Cloud and marketing website. Learn how we handle your data and protect your privacy."
			...
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					<h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
						MeowCode Cloud Privacy Policy
					</h1>
					<p className="text-muted-foreground">Last Updated: September 19, 2025</p>

					<p className="lead">
						This Privacy Policy explains how MeowCode, Inc. (&quot;MeowCode,&quot; &quot;we,&quot;
						&quot;our,&quot; or &quot;us&quot;) collects, uses, and shares information when you:
					</p>
					<ul className="lead">
						<li>
							browse any page under <strong>TODOURL</strong> (the <em>Marketing Site</em>); and/or
						</li>
						<li>
							create an account for, sign in to, or otherwise use <strong>MeowCode Cloud</strong> at{" "}
							<strong>app.TODOURL</strong> or through the MeowCode extension while authenticated to
					...
					<div className="my-8 rounded-lg border border-border bg-muted/50 p-6">
						...
						<p className="mb-0">
							If you run the MeowCode extension <strong>without</strong> connecting to a Cloud account,
							your data is governed by the standalone{" "}
							<a
								href="https://github.com/MeowCodeInc/Meow-Code/blob/main/PRIVACY.md"
								target="_blank"
								rel="noopener noreferrer"
								className="text-primary hover:underline">
								MeowCode Extension Privacy Policy
							</a>
							.
						</p>
					</div>
					...
					<ul>
						<li>
							<strong>
								Your source code does not transit MeowCode servers unless you explicitly choose MeowCode
								as a model provider (proxy mode).
							</strong>{" "}
							When MeowCode Cloud is your model provider, your code briefly transits MeowCode servers only
							...
							TLS—to the model you select. MeowCode never stores, inspects, or trains on your code.
						</li>
						<li>
							<strong>Prompts and chat snippets are collected by default</strong> in MeowCode Cloud so you
							can search and re‑use past conversations. Organization admins can disable this collection at
							any time.
						</li>
						<li>
							We collect only the data needed to operate MeowCode Cloud, do <strong>not</strong> sell
					...
					<ul>
						<li>
							<strong>Operate & secure MeowCode Cloud</strong> (authentication, completions, abuse
							prevention)
						</li>
						<li>
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Your chosen model provider (direct client → provider TLS), or MeowCode (proxy
										mode; transit‑only) when you select MeowCode as the provider
									</td>
									<td className="border border-border px-4 py-2">
										MeowCode servers (except proxy mode; transit‑only, no storage); ad networks;
								...
								<tr className="bg-muted/25">
									...
									<td className="border border-border px-4 py-2">
										MeowCode Cloud (encrypted at rest)
									</td>
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										MeowCode servers (we store only the Stripe customer ID)
									</td>
								</tr>
							</tbody>
						</table>
					...
					<ul>
						<li>
							<strong>Source Code:</strong> Never stored on MeowCode servers.
						</li>
						<li>
					...
					<ul>
						...
						<li>
							...
							<strong>Security Settings</strong> inside MeowCode Cloud (User Menu &rarr; My Settings
							&rarr; Open Profile).
						</li>
						<li>
					...
					<p>
						...
						<a href="mailto:privacy@TODOURL" className="text-primary hover:underline">
							privacy@TODOURL
						</a>
						.
					</p>
