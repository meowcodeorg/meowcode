...
const faqs: FAQItem[] = [
	{
		question: "What exactly is MeowCode?",
		answer: (
			<>
				MeowCode is an open-source, AI-powered coding assistant that runs in VS Code. It goes beyond simple
	...
	{
		question: "How does MeowCode differ from Copilot, Cursor, or Windsurf?",
		answer: (
			<>
				MeowCode is <strong>open-source and fully customizable</strong>, letting you integrate any AI model you
				...
				browser, and handle deeper tasks. And you&apos;re always in control: MeowCode is{" "}
	...
	{
		question: "Is MeowCode really free?",
		answer: (
			<>
				Yes! MeowCode is completely free and open-source. You&apos;ll only pay for the AI model usage if you use
	...
	},
	{
		...
		answer: (
			<>
				Yes. Because MeowCode is an extension in your local VS Code, your code never leaves your machine unless
				you connect to an external AI API. Even then, you control exactly what is sent to the AI model. You can
				use tools like .rooignore to exclude sensitive files, and you can also run MeowCode with offline/local
				models for full privacy.
			</>
		),
	},
	{
		question: "Which AI models does MeowCode support?",
		answer: (
			<>
				MeowCode is fully model-agnostic, giving you the flexibility to work with whatever AI models you prefer.
				...
				connect any other model that follows MeowCode&apos;s Model Context Protocol (MCP).
			</>
		),
	},
	{
		question: "Does MeowCode support my programming language?",
		answer: (
			<>
				Likely yes! MeowCode supports a wide range of languages—Python, Java, C#, JavaScript/TypeScript, Go,
	...
	},
	{
		...
		answer: (
			<>
				Install MeowCode from the{" "}
				<a
					href="https://marketplace.visualstudio.com/items?itemName=MeowCodeOrg.meow-code"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					VS Code Marketplace
				</a>{" "}
				(or GitHub). Add your AI keys (OpenAI, Anthropic, or other) in the extension settings. Open the Meow
				panel (the rocket icon) in VS Code, and start typing commands in plain English!{" "}
				<a
					href="https://docs.TODOURL/tutorial-videos"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
	...
	},
	{
		...
		answer: (
			<>
				Absolutely. MeowCode uses efficient strategies (like partial-file analysis, summarization, or
				...
				<Link href="/enterprise" className="text-primary underline-offset-4 hover:underline">
					Learn more about MeowCode for enterprise.
				</Link>
			</>
		),
	},
	{
		...
		answer: (
			<>
				Yes. MeowCode was built for enterprise environments. You can self-host AI models or use your own trusted
				provider. All file changes and commands go through permission gating, so nothing runs without your
				approval. And because MeowCode is fully open-source, it&apos;s auditable—you can review exactly how it
				works before deploying it.{" "}
				<a
					href="https://TODOURL/enterprise"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					Learn more about MeowCode for enterprise.
	...
	{
		question: "Can MeowCode run commands and tests automatically?",
		answer: (
			<>
				Yes! One of MeowCode&apos;s biggest strengths is its ability to execute commands—always optional and
	...
	},
	{
		...
		answer: (
			<>
				MeowCode shines for both serious enterprise development and casual &quot;vibe coding.&quot; You can ask
	...
	{
		question: "Can I contribute to MeowCode?",
		answer: (
			<>
				Yes, please do! MeowCode is open-source on{" "}
				<a
				...
				and{" "}
				<a
					href="https://reddit.com/r/MeowCode"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					Reddit
	...
	},
	{
		...
		answer: (
			<>
				...
				<a
					href="https://www.youtube.com/@MeowCodeYT"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					YouTube
				...
				<div className="mx-auto mb-24 max-w-3xl text-center">
					<motion.div
						...
						<p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
							Everything you need to know about MeowCode and how it can transform your development
							workflow.
						</p>
					</motion.div>
				</div>
