...
<p align="center">
  <em>Obtén ayuda rápido → <a href="https://discord.gg/meowcode">Únete a Discord</a> • ¿Prefieres asíncrono? → <a href="https://www.reddit.com/r/MeowCode/">Únete a r/MeowCode</a></em>
</p>
...
- Se añadió compatibilidad con OpenAI GPT-5.4 y GPT-5.3 Chat Latest para que puedas usar los modelos de chat más recientes de OpenAI en MeowCode.
...
## ¿Qué puede hacer MeowCode por TI?
...
MeowCode se adapta a tu forma de trabajar, no al revés:
...
Más info: [Usar Modos](https://docs.TODOURL/basic-usage/using-modes) • [Modos Personalizados](https://docs.TODOURL/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.TODOURL/tutorial-videos">Más tutoriales rápidos y vídeos de funcionalidades...</a>
</p>

## Recursos

- **[Documentación](https://docs.TODOURL):** La guía oficial para instalar, configurar y dominar MeowCode.
- **[Canal de YouTube](https://youtube.com/@meowcodeyt?feature=shared):** Mira tutoriales y ve las funcionalidades en acción.
- **[Servidor de Discord](https://discord.gg/meowcode):** Únete a la comunidad para obtener ayuda y discutir en tiempo real.
- **[Comunidad de Reddit](https://www.reddit.com/r/MeowCode):** Comparte tus experiencias y ve lo que otros están construyendo.
- **[Incidencias de GitHub](https://github.com/MeowCodeInc/MeowCode/issues):** Reporta errores y sigue el desarrollo.
- **[Solicitudes de funcionalidades](https://github.com/MeowCodeInc/MeowCode/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** ¿Tienes una idea? Compártela con los desarrolladores.
...
Hay varias formas de ejecutar la extensión MeowCode:

### Modo de desarrollo (F5)

Para el desarrollo activo, utiliza la depuración integrada de VSCode:

Presiona `F5` (o ve a **Ejecutar** → **Iniciar depuración**) en VSCode. Esto abrirá una nueva ventana de VSCode con la extensión MeowCode en ejecución.
...
1.  Primero, construye el paquete VSIX:
    ...
    pnpm vsix
    ```
2.  Se generará un archivo `.vsix` en el directorio `bin/` (p. ej., `bin/meow-code-<version>.vsix`).
