...
<p align="center">
  <em>Snel hulp krijgen → <a href="https://discord.gg/meowcode">Word lid van Discord</a> • Liever asynchroon? → <a href="https://www.reddit.com/r/MeowCode/">Word lid van r/MeowCode</a></em>
</p>
...
- Ondersteuning toegevoegd voor OpenAI GPT-5.4 en GPT-5.3 Chat Latest, zodat je de nieuwste OpenAI-chatmodellen in MeowCode kunt gebruiken.
...
## Wat kan MeowCode voor JOU doen?
...
MeowCode past zich aan jouw werkwijze aan, niet andersom:
...
Meer info: [Modi gebruiken](https://docs.TODOURL/basic-usage/using-modes) • [Aangepaste modi](https://docs.TODOURL/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.TODOURL/tutorial-videos">Meer snelle tutorial- en featurevideo's...</a>
</p>

## Hulpbronnen

- **[Documentatie](https://docs.TODOURL):** De officiële gids voor het installeren, configureren en beheersen van MeowCode.
- **[YouTube-kanaal](https://youtube.com/@meowcodeyt?feature=shared):** Bekijk tutorials en zie functies in actie.
- **[Discord Server](https://discord.gg/meowcode):** Word lid van de community voor realtime hulp en discussie.
- **[Reddit Community](https://www.reddit.com/r/MeowCode):** Deel je ervaringen en kijk wat anderen bouwen.
- **[GitHub Issues](https://github.com/MeowCodeInc/MeowCode/issues):** Meld bugs en volg de ontwikkeling.
- **[Feature Requests](https://github.com/MeowCodeInc/MeowCode/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Heb je een idee? Deel het met de ontwikkelaars.
...
Er zijn verschillende manieren om de MeowCode-extensie uit te voeren:

### Ontwikkelmodus (F5)

Gebruik voor actieve ontwikkeling de ingebouwde foutopsporing van VSCode:

Druk op `F5` (of ga naar **Uitvoeren** → **Foutopsporing starten**) in VSCode. Dit opent een nieuw VSCode-venster waarin de MeowCode-extensie wordt uitgevoerd.
...
1.  Bouw eerst het VSIX-pakket:
    ...
    pnpm vsix
    ```
2.  Een `.vsix`-bestand wordt gegenereerd in de `bin/`-directory (bijv. `bin/meow-code-<version>.vsix`).
...
**Veel plezier met MeowCode!** Of je het nu strak aan de lijn houdt of autonoom laat rondlopen, we zijn benieuwd wat je bouwt. Vragen of feature-ideeën? Kom langs op onze [Reddit-community](https://www.reddit.com/r/MeowCode/) of [Discord](https://discord.gg/meowcode). Happy coding!
