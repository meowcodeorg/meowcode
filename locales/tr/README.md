...
<p align="center">
  <em>Hızlı yardım alın → <a href="https://discord.gg/meowcode">Discord'a Katılın</a> • Asenkron mu tercih edersiniz? → <a href="https://www.reddit.com/r/MeowCode/">r/MeowCode'a Katılın</a></em>
</p>
...
- MeowCode içinde en yeni OpenAI sohbet modellerini kullanabilmen için OpenAI GPT-5.4 ve GPT-5.3 Chat Latest desteği eklendi.
...
## MeowCode SİZİN İçin Ne Yapabilir?
...
MeowCode, sizin çalışma şeklinize uyum sağlar, tam tersi değil:
...
Daha fazla: [Modları kullanma](https://docs.TODOURL/basic-usage/using-modes) • [Özel modlar](https://docs.TODOURL/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.TODOURL/tutorial-videos">Daha fazla hızlı eğitim ve özellik videosu...</a>
</p>

## Kaynaklar

- **[Dokümantasyon](https://docs.TODOURL):** MeowCode'u yükleme, yapılandırma ve ustalaşma konusundaki resmi kılavuz.
- **[YouTube Kanalı](https://youtube.com/@meowcodeyt?feature=shared):** Eğitimleri izleyin ve özellikleri çalışırken görün.
- **[Discord Sunucusu](https://discord.gg/meowcode):** Gerçek zamanlı yardım ve tartışma için topluluğa katılın.
- **[Reddit Topluluğu](https://www.reddit.com/r/MeowCode):** Deneyimlerinizi paylaşın ve başkalarının ne inşa ettiğini görün.
- **[GitHub Sorunları](https://github.com/MeowCodeInc/MeowCode/issues):** Hataları bildirin ve gelişimi takip edin.
- **[Özellik İstekleri](https://github.com/MeowCodeInc/MeowCode/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Bir fikriniz mi var? Geliştiricilerle paylaşın.
...
MeowCode uzantısını çalıştırmanın birkaç yolu vardır:

### Geliştirme Modu (F5)

Aktif geliştirme için VSCode'un yerleşik hata ayıklama özelliğini kullanın:

VSCode'da `F5` tuşuna basın (veya **Çalıştır** → **Hata Ayıklamayı Başlat**'a gidin). Bu, MeowCode uzantısının çalıştığı yeni bir VSCode penceresi açacaktır.
...
1.  İlk olarak, VSIX paketini oluşturun:
    ...
    pnpm vsix
    ```
2.  `bin/` dizininde bir `.vsix` dosyası oluşturulur (ör. `bin/meow-code-<version>.vsix`).
...
**MeowCode'un keyfini çıkar!** Onu kısa tasmalı tut ya da otonom dolaşsın; ne inşa edeceğini görmek için sabırsızlanıyoruz. Soruların veya özellik fikirlerin varsa [Reddit topluluğumuza](https://www.reddit.com/r/MeowCode/) ya da [Discord](https://discord.gg/meowcode)'a uğra. İyi kodlamalar!
