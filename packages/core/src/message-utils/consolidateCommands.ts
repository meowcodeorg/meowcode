...
/**
 * Consolidates sequences of command and command_output messages in an array of MeowCodeMessages.
 * Also consolidates sequences of use_mcp_server and mcp_server_response messages.
 *
 * This function processes an array of MeowCodeMessages objects, looking for sequences
 ...
 * @returns A new array of MeowCodeMessage objects with command and MCP sequences consolidated.
 *
 * @example
 ...
 */
export function consolidateCommands(messages: MeowCodeMessage[]): MeowCodeMessage[] {
	const consolidatedMessages = new Map<number, MeowCodeMessage>()
