import type { TokenUsage, ToolUsage, ToolName, MeowCodeMessage } from "@meow-code/types"
...
/**
 * Consolidates token usage metrics from an array of MeowCodeMessages.
 *
 ...
 */
export function consolidateTokenUsage(messages: MeowCodeMessage[]): TokenUsage {
