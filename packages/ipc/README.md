...
This package provides IPC functionality for MeowCode, allowing external applications to communicate with the extension through a socket-based interface.
...
- `configuration`: MeowCode settings object
...
- Unix/Linux/macOS: `/tmp/meow-code-{id}.sock`
- Windows: `\\.\pipe\meow-code-{id}`
