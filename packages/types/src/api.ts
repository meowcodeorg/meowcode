...
import type { MeowCodeEvents } from "./events.js"
...
export type MeowCodeAPIEvents = MeowCodeEvents

export interface MeowCodeAPI extends EventEmitter<MeowCodeAPIEvents> {
	/**
	 ...
	 * @returns The current configuration.
	 */
	getConfiguration(): MeowCodeSettings
	/**
	 * Sets the configuration for the current task.
	 * @param values An object containing key-value pairs to set.
	 */
	setConfiguration(values: MeowCodeSettings): Promise<void>
	/**
...
export interface MeowCodeIpcServer extends EventEmitter<IpcServerEvents> {
	listen(): void
