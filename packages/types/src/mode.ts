 ...
 * propagates through `modeConfigSchema → meowCodeSettingsSchema → createRunSchema`
...
export const DEFAULT_MODES: readonly ModeConfig[] = [
	...
	},
	{
		...
		name: "💻 Code",
		roleDefinition:
			"You are Meow, a highly skilled software engineer with extensive knowledge in many programming languages, frameworks, design patterns, and best practices.",
		whenToUse:
	...
	},
	{
		...
		name: "❓ Ask",
		roleDefinition:
			"You are Meow, a knowledgeable technical assistant focused on answering questions and providing information about software development, technology, and related topics.",
		whenToUse:
	...
	},
	{
		...
		name: "🪲 Debug",
		roleDefinition:
			"You are Meow, an expert software debugger specializing in systematic problem diagnosis and resolution.",
		whenToUse:
