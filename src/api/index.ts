...
import { isRetiredProvider, type ProviderSettings, type ModelInfo } from "@meow-code/types"
...
export function buildApiHandler(configuration: ProviderSettings): ApiHandler {
	...
	switch (apiProvider) {
		...
		case "roo":
			...
			return new MeowHandler(options)
