// npx vitest core/ignore/__tests__/MeowIgnoreController.spec.ts

import type { Mock } from "vitest"

import { MeowIgnoreController, LOCK_TEXT_SYMBOL } from "../MeowIgnoreController"
...
describe("MeowIgnoreController", () => {
	const TEST_CWD = "/test/path"
	let controller: MeowIgnoreController
	...
	beforeEach(() => {
		...
		// Create controller
		controller = new MeowIgnoreController(TEST_CWD)
	})
	...
	describe("validateAccess", () => {
		...
		it("should allow all access when no .rooignore content", async () => {
			...
			mockFileExists.mockResolvedValue(false)
			const emptyController = new MeowIgnoreController(TEST_CWD)
