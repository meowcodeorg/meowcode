...
describe("RooIgnore Response Formatting", () => {
	...
	describe("formatResponse.formatFilesList with MeowIgnoreController", () => {
		/**
		 * Tests file listing with rooignore controller
		 */
		it("should format files list with lock symbols for ignored files", async () => {
			// Create controller
			const controller = new MeowIgnoreController(TEST_CWD)
		...
		/**
		 * Tests formatFilesList handles truncation correctly with MeowIgnoreController
		 */
		it("should handle truncation with MeowIgnoreController", async () => {
			// Create controller
			const controller = new MeowIgnoreController(TEST_CWD)
			await controller.initialize()
		 ...
		 */
		it("should handle empty file list with MeowIgnoreController", async () => {
			// Create controller
			const controller = new MeowIgnoreController(TEST_CWD)
			await controller.initialize()
