...
export class McpServerManager {
	...
	private static providers: Set<MeowCodeProvider> = new Set()
	 ...
	 */
	static async getInstance(context: vscode.ExtensionContext, provider: MeowCodeProvider): Promise<McpHub> {
	 ...
	 */
	static unregisterProvider(provider: MeowCodeProvider): void {
