 ...
 *
 * This class manages the state for the marketplace view in the MeowCode extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the MeowCode extensions interface
...
import { MarketplaceItem, MarketplaceInstalledMetadata } from "@meow-code/types"
