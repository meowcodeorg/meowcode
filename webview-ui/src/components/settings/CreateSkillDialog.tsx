...
import { validateSkillName as validateSkillNameShared, SkillNameValidationError } from "@meow-code/types"
...
/**
 * Validate skill name using shared validation from @meow-code/types.
